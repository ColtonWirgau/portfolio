...
// Glass treatment shared by the two floating header controls. The bar
// itself is transparent; only the squid and Contact sit on glass. No
// border: the tint matches the paper, so the glass should be invisible
// until content actually scrolls underneath it.
