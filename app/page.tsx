  ...
  return (
    <div className="h-screen bg-bg overflow-hidden relative">
      ...
      <main ref={mainRef} className="h-full overflow-y-auto relative" style={{ paddingBottom: '0' }}>
        ...
        {/* My Story section */}
        <section style={{ padding: '80px 24px', display: 'flex' }}>
          <div style={{ flex: 1, minWidth: 0 }}>
            <MyStory />
          </div>
          <SideLabel label="My Story" side="right" mirrorLabel />
        </section>
        ...
        <section id="about" style={{ padding: '80px 24px', display: 'flex', position: 'relative', minHeight: '100vh' }}>
          ...
          <div style={{ marginBottom: '48px' }}>
            <SectionHeading
              ...
              subtitle={<>Full-stack developer, <Em>musician</Em>, and lifelong sports fan based in Southeast Michigan. I build tools that make <Ul>complexity feel simple</Ul>.</>}
            />
          </div>
